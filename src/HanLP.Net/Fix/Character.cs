...
namespace HanLP.Net.Fix
{
    /// <summary>
    /// 修复C# 对应 Java Character 类确实的问题
    /// </summary>
    public class Character
    {
        ...
        public class UnicodeBlock
        {
            ...
            private UnicodeBlock(string idName, params string[] aliases) {
            ...
            public static UnicodeBlock SURROGATES_AREA =
            ...
            public static uint MAX_CODE_POINT = 0X10FFFF;

            public static bool IsValidCodePoint(int codePoint) {
                uint plane = (uint)codePoint >> 16;
